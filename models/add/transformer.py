...
class TransformerLayer(nn.Module):
    ...
    def forward(self, source, target,
        ...
        if attn_type and 'swin' in attn_type and attn_num_splits is not None and attn_num_splits > 1:
...
class FeatureTransformer(nn.Module):
    ...
    def forward(self, feature0, feature1,
        ...
        # 1d attention
        if attn_type and 'swin1d' in attn_type and attn_num_splits is not None and attn_num_splits > 1:
        ...
        for i, layer in enumerate(self.layers):
            concat0 = layer(concat0, concat1,
                            ...
                            with_shift=(
                                    attn_type and
                                    'swin' in attn_type and
                                    attn_num_splits is not None and
                                    attn_num_splits > 1 and
                                    i % 2 == 1
                            ),
                            attn_num_splits=attn_num_splits,
                            shifted_window_attn_mask=shifted_window_attn_mask,
